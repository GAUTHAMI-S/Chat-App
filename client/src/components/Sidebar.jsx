...
const Sidebar = () => {
    ...
    return (
        <div className={`${selectedUser ? 'max-md:hidden' : ''}bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white`}>
            <div className='pb-5'>
                <div className='flex justify-between items-center '>
                    <img src={assets.logo} alt="logo" className='max-w-40' />
                    <div className='relative pu-2 group '>
                ...
                <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-4'>
                    ...
                    <input placeholder='Search User...' type="text" className='bg-transparent border-none outline-none text-white text-xs placeholder-[#c8c8c8] flex-1'
                    ...
                    (
                        <div onClick={() => { setSelectedUser(user); setUnseenMessages(prev => ({ ...prev, [user._id]: 0 })) }}
                         ...
                         ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
                            <img className='w-[35px] aspect-[1/1] rounded-full'
